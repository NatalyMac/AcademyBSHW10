...
<div class="container">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="col-xs-12 main-container"></div><!------------------------------------------------><script type="text/template" id="tpl-contact">
    <td><%- firstname %></td>
    <td><%- lastname %></td>
    <td><%- email %></td>
    <td><%- role %></td>
...
</script><!------------------------------------------------><script type="text/template" id="tpl-new-contact">
...
</script><!------------------------------------------------><script type="text/template" id="tpl-books">
...
</script><!------------------------------------------------><script type="text/template" id="tpl-book">
    <td><%- genre %></td>
    <td><%- title %></td>
    <td><%- author %></td>
    <td><%- year %></td>
...
</script><!------------------------------------------------><script type="text/template" id="tpl-user-detail">
...
</script><!------------------------------------------------><script type="text/template" id="tpl-users-books">
    <h2>List of Books</h2>
...
</script><!------------------------------------------------><script type="text/template" id="tpl-user-book">
    <td><%- genre %></td>
    <td><%- title %></td>
    <td><%- author %></td>
    <td><%- year %></td>
...
</script><!------------------------------------------------><script type="text/template" id="tpl-new-charge">
    <form role="form" class="form-horizontal contract-form">
...
</script><!------------------------------------------------><script type="text/template" id="tpl-users">
